    ...
    def calculator(switch_mode: bool, switcher: str = None, values: tuple = None):
            ...
            while True:
                ...
                if choice in ("1", "2", "3", "4", "5", "6"):
                    ...
                    if choice == '1':
                        ...
                        subt_function(numbers)
        
                    elif choice == '3':
                        mult_function(numbers)
        
                    elif choice == '4':
                        div_function(numbers)
        
                    elif choice == '5':
                        sqr_function(numbers)

                    elif choice == '6':
                        mod_function(numbers)
                    ...
                    if choice == '7':
                        ...
                        circumference_function(number)
            
                    elif choice == '9':
                        area_function(number)
                        ...
                        to_rad_function(number)
            
                    elif choice == '14':
                        to_deg_function(number)
        ...
        def switch_interact(switch: str):
                if switch in ("1", "2", "3", "4", "5", "6"):
                    if switch == '1':
                        add_function(values, True)
        
                    elif switch == '2':
                        subt_function(values, True)
        
                    elif switch == '3':
                        mult_function(values, True)
        
                    elif switch == '4':
                        div_function(values, True)
        
                    elif switch == '5':
                        sqr_function(values, True)

                    elif switch == '6':
                        mod_function(values, True)

                elif switch in ("7", "8", "9", "10", "11", "12", "13", "14"):
                    if switch == '7':
                        sqrt_function(values[0], True)
            
                    elif switch == '8':
                        circumference_function(values[0], True)
            
                    elif switch == '9':
                        area_function(values[0], True)
            
                    elif switch == '13':
                        to_rad_function(values[0], True)
            
                    elif switch == '14':
                        to_deg_function(values[0], True)
